...
public class CoverLoader {
    ...
    public Bitmap loadThumbnail(String uri) {
        ...
        if (TextUtils.isEmpty(uri)) {
            ...
            if (bitmap == null) {
                bitmap = BitmapFactory.decodeResource(KBaseApplication.getInstance().getResources(), R.drawable.default_cover);
    ...
    public Bitmap loadBlur(String uri) {
        ...
        if (TextUtils.isEmpty(uri)) {
            ...
            if (bitmap == null) {
                bitmap = BitmapFactory.decodeResource(KBaseApplication.getInstance().getResources(), R.drawable.play_page_default_bg);
            ...
            if (bitmap == null) {
                ...
                if (bitmap == null) {
                    ...
                    //bitmap = ImageUtils.blur(bitmap, ImageUtils.BLUR_RADIUS,true);
                }
    ...
    public Bitmap loadRound(String uri) {
        ...
        if (TextUtils.isEmpty(uri)) {
            ...
            if (bitmap == null) {
                bitmap = BitmapFactory.decodeResource(KBaseApplication.getInstance().getResources(), R.drawable.play_page_default_cover);
