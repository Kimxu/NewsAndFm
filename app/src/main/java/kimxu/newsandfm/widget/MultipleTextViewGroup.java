...
import kimxu.bdyy.search.searchhot.Result;
...
public class MultipleTextViewGroup extends RelativeLayout {
    ...
    public MultipleTextViewGroup(Context context, AttributeSet attrs) {
        ...
        textColor = array.getColor(R.styleable.MultipleTextViewGroup_mTextColor, 0XFF00FF00); // 提供默认值，放置未指定
        textSize = array.getDimension(R.styleable.MultipleTextViewGroup_mTextSize, 24);
        textSize = px2sp(context, textSize);
        wordMargin = array.getDimensionPixelSize(R.styleable.MultipleTextViewGroup_mTextWordMargin, 0);
        lineMargin = array.getDimensionPixelSize(R.styleable.MultipleTextViewGroup_mTextLineMargin, 0);
        textBackground = array.getResourceId(R.styleable.MultipleTextViewGroup_mTextBackground, -1);
        //array.getc
        textPaddingLeft = array.getDimensionPixelSize(R.styleable.MultipleTextViewGroup_mTextPaddingLeft, 0);
        textPaddingRight = array.getDimensionPixelSize(R.styleable.MultipleTextViewGroup_mTextPaddingRight, 0);
        textPaddingTop = array.getDimensionPixelSize(R.styleable.MultipleTextViewGroup_mTextPaddingTop, 0);
        textPaddingBottom = array.getDimensionPixelSize(R.styleable.MultipleTextViewGroup_mTextPaddingBottom, 0);
    ...
    public void setTextViews(final List<Result> dataList) {
        if (layout_width >= 0) {
    ...
    private void setTextViewsTrue(List<Result> dataList) {
        ...
        for (int i = 0; i < dataList.size(); i++) {
            ...
            tv.setText(dataList.get(i).getWord());
